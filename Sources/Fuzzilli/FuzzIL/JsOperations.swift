...
final class BeginForAwaitOfLoop: JsOperation {
    ...
    init() {
        ...
        super.init(numInputs: 1, numInnerOutputs: 1, attributes: [.isBlockStart, .propagatesSurroundingContext], requiredContext: [.javascript, .asyncFunction], contextOpened: [.javascript, .loop])
    }
}
...
final class BeginForAwaitOfLoopWithDestruct: JsOperation {
    ...
    init(indices: [Int64], hasRestElement: Bool) {
        ...
        self.indices = indices
        self.hasRestElement = hasRestElement
        super.init(numInputs: 1, numInnerOutputs: indices.count, attributes: [.isBlockStart, .propagatesSurroundingContext], requiredContext: [.javascript, .asyncFunction], contextOpened: [.javascript, .loop])
    }
}
